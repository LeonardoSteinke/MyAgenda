...
<body>
    <div class="container my-5">
        ...
        <button type="submit" name="submit" class="btn btn-danger" onclick="window.location.href='index.php?pessoaId=<?= $id ?>'">Voltar</button>
        <form method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="descricao" class="form-control" name="descricao" id="descricao" autocomplete="off" />
            </div>
